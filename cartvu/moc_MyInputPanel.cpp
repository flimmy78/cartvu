...
**
** Created: Fri Jun 13 18:11:04 2014
...
static const char qt_meta_stringdata_MyInputPanel[] = {
    ...
    "sendInt(int)\0send_info(QString)\0"
    "oldFocus,newFocus\0saveFocusWidget(QWidget*,QWidget*)\0"
    "w\0btnClicked(QWidget*)\0character\0"
    "this_charSlot(QChar)\0this_intSlot(int)\0"
};
...
int MyInputPanel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: send_info((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: saveFocusWidget((*reinterpret_cast< QWidget*(*)>(_a[1])),(*reinterpret_cast< QWidget*(*)>(_a[2]))); break;
        case 4: btnClicked((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 5: this_charSlot((*reinterpret_cast< QChar(*)>(_a[1]))); break;
        case 6: this_intSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 7;
    }
...
// SIGNAL 2
void MyInputPanel::send_info(QString _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
